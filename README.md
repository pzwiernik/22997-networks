...
| 2 | Degree distribution, graph isomorphisc, adjacency matrix. <br> Distance in graphs, diameter, connectivity, trees.  | [slides3](./slides/lecture3.pdf) <br> slides4 | -|  | 6/7 Oct | report topics published|
